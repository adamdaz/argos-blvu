...
blvu1$dt2 <- strptime(blvu1$dt, format = "%m/%d/%Y %H:%M:%S",tz = "GMT")
...
glmm1 <- lme4::lmer (agl ~ dems + dem2s + flat*east + flat*east2 + flat*north + flat*north2 + dprds + dprd2s + dsrds + dsrd2s + dsolids + dsolid2s + dforests + dforest2s + nlcdcat + tpicat + tricat + (1|id) , data = fly1 , na.action = na.fail)
